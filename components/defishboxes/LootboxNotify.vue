<template>
    ...
    >
        <v-card flat class="vendor-popup-inner rounded-xl" tile>
            ...
            >
                <div class="notify white--text font-weight-medium">Congratulations!</div>
            ...
            <div class="d-flex flex-column align-center">
                ...
                <!-- <v-btn href="https://test-marketplace.worldofdefish.com/profile" class="mb-8" rounded text color="primary">
                    <LootBox style="position: relative; top: 0; right: 8%" />
                    Marketplace
                </v-btn> -->
            </div>
        </v-card>
...
<script>
    import LootBox from "@/components/defishboxes/LootBoxIcon.vue";
