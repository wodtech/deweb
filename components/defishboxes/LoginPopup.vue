<template>
    <div>
        ...
        <v-dialog
                ...
                max-width="400px"
        >
            <v-card flat class="login-popup-inner rounded-xl pa-8 d-flex flex-column align-center" tile style="position: relative; background:linear-gradient(39.79deg, rgba(41, 77, 87, 0.7) 4.57%,rgba(42, 81, 90, 0.322) 89.2%)">
    ...
    export default {
        ...
        methods: {
            async loginFlow(wallet) {
                await this.$store.dispatch("web3/load", wallet).then(
                    async () =>{
