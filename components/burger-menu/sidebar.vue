      ...
      <div v-if="value" class="sidebar-panel">
        ...
        <div class="sidebar-panel-nav">
          ...
          <div class="socials mt-11">
            <v-btn target="_blank"  variant="text" :href="social_links.twitter" icon>
              <v-icon size="28px">mdi-twitter</v-icon>
            </v-btn>

            <v-btn target="_blank" :href="social_links.medium" variant="text" icon>
              <svg
                  style="width: 24px"
                  width="69"
                  height="41"
            ...
            <v-btn target="_blank" :href="social_links.discord" variant="text" icon>
              <svg
                  width="24"
                  height="28"
                  viewBox="0 0 24 28"
            ...
            <v-btn target="_blank" :href="social_links.linkedin" variant="text" icon>
              <v-icon size="28px">mdi-linkedin</v-icon>
            </v-btn>
          </div>
        </div>
      </div>
